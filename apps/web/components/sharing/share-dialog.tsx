...
// Custom social icons as components (lucide doesn't have brand icons)
  ...
  const socialButtons = [
    {
      ...
      icon: TwitterIcon,
      onClick: () =>
        openShareWindow(getTwitterShareUrl(shareContent("twitter"))),
    ...
    },
    {
      ...
      icon: FacebookIcon,
      onClick: () =>
        openShareWindow(getFacebookShareUrl(shareContent("facebook"))),
    ...
    },
    {
      ...
      icon: LinkedInIcon,
      onClick: () =>
        openShareWindow(getLinkedInShareUrl(shareContent("linkedin"))),
    ...
    },
    {
      ...
      icon: WhatsAppIcon,
      onClick: () =>
        window.open(getWhatsAppShareUrl(shareContent("whatsapp")), "_blank"),
    ...
    },
    {
      ...
      icon: Mail,
      onClick: () => {
        window.location.href = getEmailShareUrl(shareContent("email"));
      },
